...
\begin{document}
    ...
    \input{sections/definitions-notations-conventions.tex}
    ...
    \input{sections/polynomial-p-and-its-properties.tex}
    ...
    \input{sections/odd-binomial-theorem-as-partial-case-of-p.tex}
    ...
    \input{sections/relation-between-p-and-convolution-of-polynomials.tex}
