...
\begin{table}[H]
    ...
    \href{https://oeis.org/A302971}{\texttt{A302971}},
        \href{https://oeis.org/A304042}{\texttt{A304042}}.} \label{tab:table}
\end{table}
...
\begin{equation*}
    ...
    \end{split}
\end{equation*}
Given the power sum $S_{r} (b) = \sum_{k=0}^{b} k^{r}$ we get
\begin{equation*}
    \polynomialP{m}{b}{x}
    = \sum_{r=0}^{m} (-1)^{r} x^{r} \coeffA{m}{r} \sum_{j=0}^{r} \frac{1}{(-1)^j} \binom{r}{j} S_{2r-j} (b-1)
\end{equation*}
